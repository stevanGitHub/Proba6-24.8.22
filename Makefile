...
LIBS = \
  ${DIR_LIBS}/hw.lib \
  ${DIR_LIBS}/mem.lib \
  ${DIR_LIBS}/console.lib #kasnije ovde treba uraditi izmenu, izbrisati ove dve bibliotke nakon sto se impl
